...
Now, let's think about the solution that assigning $i$ to $j$ which $i$ that contributes to $j$ and assigning $i$ to facility $j$ in $T'$ for $i$ that doesn't contributes to the facility such that maximizes $v_j$ which $i$ assigned to $j$ $\in$ $T'$.
